...
dim1=ncdim_def("HRU",units="HRU_ID",HRUlist,longname="HRU_basins")
dim2=ncdim_def("time",units="days since 1950-01-01 00:00:00",time,longname="days since 1950-01-01 00:00:00")
HRU_def=ncvar_def(Var,"celcius",list(dim1,dim2),prec="float")
ncout=nc_create(file.path(output.dir, paste(Var,".HRU.timeseries.DRAFT.nc",sep="")),
                list(HRU_def),force_v4=T)
